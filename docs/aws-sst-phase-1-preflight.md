...
- The local platform matches SST's current `arm64` service architecture. Explicit `--platform linux/arm64` keeps local preflight aligned with GitHub/SST deploy defaults.
