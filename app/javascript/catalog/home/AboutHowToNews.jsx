...
const HOW_TO_ICON_CLASS_BY_TYPE = {
  guide: 'bp4-icon-manual',
  video: 'bp4-icon-video',
}
...
function HowToListItem({ href, iconType = 'guide', children }) {
  ...
  return (
    <li>
      <HowToLink href={href}>
        <HowToIcon className={`bp4-icon ${iconClass}`} aria-hidden />
        {children}
      </HowToLink>
    </li>
  )
    ...
    <Columns>
      <StyledCatalogSection solid $hasMoreLink>
        ...
        <AboutList>
          ...
          <li>
            <AboutLink href="https://docs.google.com/forms/d/e/1FAIpQLScJ9EeCZFjBIN9qWjvbHoJ7wXDyzbqTVYoQN-DIDL3yDzzPHw/viewform?usp=publish-editor">
            ...
            >
              <SocialLinks>
                <SocialLink
                  ...
                  aria-label={intl.formatMessage({
                    id: 'catalog.aboutHowToNews.linkedinAriaLabel',
                  })}
                  title="LinkedIn"
                >
                  <SocialIcon
                ...
                <SocialLink
                  ...
                  rel="noopener noreferrer"
                  aria-label={intl.formatMessage({
                    id: 'catalog.aboutHowToNews.blueskyAriaLabel',
                  })}
                  title="Bluesky"
                >
                  <SocialIcon
                ...
                <SocialLink
                  ...
                  rel="noopener noreferrer"
                  aria-label={intl.formatMessage({
                    id: 'catalog.aboutHowToNews.githubAriaLabel',
                  })}
                  title="GitHub"
                >
                  <SocialIcon
      ...
      <StyledCatalogSection solid $hasMoreLink>
        ...
        <VideoFrame
          title={intl.formatMessage({ id: 'catalog.aboutHowToNews.howToVideoTitle' })}
        ...
        {!loading && !error && newsItems.length > 0 && (
          <>
              ...
              {newsItems.map(item => (
                <li key={item.link}>
                  <NewsLink
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={`${item.title} ${intl.formatMessage({
                      id: 'catalog.aboutHowToNews.opensInNewTabSuffix',
                    })}`}
                  >
                    {item.title}
                  </NewsLink>
            ...
            <MoreLink
              ...
              rel="noopener noreferrer"
              aria-label={intl.formatMessage({
                id: 'catalog.aboutHowToNews.moreNewsAriaLabel',
              })}
            >
              <FormattedMessage id="catalog.aboutHowToNews.moreText" />
            </MoreLink>
...
export default injectIntl(AboutHowToNews)
...
const StyledCatalogSection = styled(CatalogSection)`
  position: relative;
  padding: 16px;
  ${props => props.$hasMoreLink && 'padding-bottom: 44px;'}
`
