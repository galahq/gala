...
class CasesTable extends React.Component {
  ...
  render () {
    let forthcomingCases = this.props.cases.filter(c => {
      return c.published !== true
    })
    let publishedCases = this.props.cases.filter(c => {
      return c.published === true
    })
    return (
      <table>
  ...
  render () {
    return (
      <section className="enrollments-section enrollments-section-cases">
        ...
        />
        <CasesTable
          cases={this.props.cases.filter(this.filter)}
          updateEnrollments={this.props.updateEnrollments}
        />
      </section>
    )
