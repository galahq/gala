...
class EdgenoteDisplay extends React.Component {
    ...
    >
      ...
      <img
        src={`${this.props.imageUrl}${
          this.props.format !== 'video' ? '?w=700&htn=3&con=-40&mono=1E2934' : ''
        }`}
      />
    </a>
  }
  ...
  renderImage () {
    return <a target="_blank" rel="noopener noreferrer" href={this.props.imageUrl}><img src={this.props.imageUrl} /></a>
  }
  ...
  renderContent () {
    if (this.props.embedCode !== null) { return this.renderTheatre() } else if (this.props.pdfUrl !== null) { return this.renderPDF() } else if (this.props.websiteUrl !== null) { return this.renderWebsiteLink() } else if (this.props.imageUrl !== null) { return this.renderImage() } else { return this.renderAside() }
  }
