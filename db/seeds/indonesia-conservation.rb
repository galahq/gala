...
indonesia_p1 = indonesia.pages.create(position: 1, title: 'The Bird’s Head Seascape')
...
indonesia_p2 = indonesia.pages.create(position: 2, title: 'A Model Seascape, a Unique Coalition')
...
indonesia_p3 = indonesia.pages.create(position: 3, title: 'Growth and Effectiveness of the Seascape')
...
indonesia_p4 = indonesia.pages.create(position: 4, title: 'Continuing Challenges')
...
indonesia_p5 = indonesia.pages.create(position: 5, title: 'The Announcement')
...
indonesia_p6 = indonesia.pages.create(position: 6, title: 'A Shared Seascape Vision')
...
indonesia_p7 = indonesia.pages.create(position: 7, title: 'Financial Analysis')
