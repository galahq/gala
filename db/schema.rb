...
ActiveRecord::Schema.define(version: 20_170_511_212_540) do
  ...
  create_table 'ahoy_events', force: :cascade do |t|
    ...
    t.index %w[name time], name: 'index_ahoy_events_on_name_and_time', using: :btree
    t.index %w[user_id name], name: 'index_ahoy_events_on_user_id_and_name', using: :btree
    t.index %w[visit_id name], name: 'index_ahoy_events_on_visit_id_and_name', using: :btree
  end
  ...
  create_table 'cards', force: :cascade do |t|
    ...
    t.index %w[element_type element_id], name: 'index_cards_on_element_type_and_element_id', using: :btree
  ...
  create_table 'case_elements', force: :cascade do |t|
    ...
    t.index %w[element_type element_id], name: 'index_case_elements_on_element_type_and_element_id', using: :btree
  end
  ...
  create_table 'readers_roles', id: false, force: :cascade do |t|
    t.integer 'reader_id'
    t.integer 'role_id'
    t.index %w[reader_id role_id], name: 'index_readers_roles_on_reader_id_and_role_id', using: :btree
  end
